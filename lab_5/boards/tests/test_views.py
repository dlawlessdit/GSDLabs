...
#Notice the change from . to .. since we have moved a level down the hierarchy
...
#Setup an object to represent one of the boards 
    def setUp(self):
        Board.objects.create(name='GSD', description='This is a board about Global Software Development')
...
#Testing if the page links back to the home page
